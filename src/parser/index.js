...
export async function parseSolanaTransaction(signature, userAccount) {
  try {
    ...
    let owner;
    if (userAccount && userAccount.length > 40) { // userAccount = string; if length > 40, it's a pubkey provided
...
module.exports.parseSolanaTransaction  
